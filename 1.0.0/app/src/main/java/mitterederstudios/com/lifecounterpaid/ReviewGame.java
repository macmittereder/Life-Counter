...
public class ReviewGame extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityreviewgame);
        Initialize();
        try{
            BufferedReader inputReader = new BufferedReader(new InputStreamReader(
                    openFileInput(savedGameName)));
            String inputString;
    ...
    private void Initialize() {
        ...
        savedGameName = gotBasket.getString("savedGameName");
        display = (TextView) findViewById(R.id.reviewGameDisplay);
